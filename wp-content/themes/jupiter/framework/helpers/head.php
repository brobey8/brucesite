...
if (!function_exists('mk_ie_compatibility_media')) {
    function mk_ie_compatibility_media() {
        ...
        echo '<![endif]-->' . "\n";
        echo '<!--[if IE 7 ]>' . "\n";
        echo '<link href="' . THEME_STYLES . '/ie7.css" media="screen" rel="stylesheet" type="text/css" />' . "\n";
        echo '<![endif]-->' . "\n";
        echo '<!--[if IE 8 ]>' . "\n";
        echo '<link href="' . THEME_STYLES . '/ie8.css" media="screen" rel="stylesheet" type="text/css" />' . "\n";
        echo '<![endif]-->' . "\n";
        echo '<!--[if lte IE 8]>' . "\n";
        echo '<script type="text/javascript" src="' . THEME_JS . '/js/respond.js"></script>' . "\n";
        echo '<![endif]-->' . "\n";
    }
